      ...
      <div class="row g-0 align-items-center">
        <div class="col-lg-6">
          <div class="img-box text-center">
            <img src="{{asset('image/others/about-us-sec-1.jpg')}}" alt="about">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="row">
            <div class="col-10 offset-1">
              <div class="about-text text-center">
                ...
                <p class="mb--40 mb-sm--30">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse
    ...
    <div class="container-fluid p-0">
      <div class="row g-0">
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="{{asset('image/icon-logo/about-us-icon1.png')}}" alt="about icon">
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="{{asset('image/icon-logo/about-us-icon2.png')}}" alt="about icon">
            </div>
            <div class="fact__content">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="{{asset('image/icon-logo/about-us-icon3.png')}}" alt="about icon">
            </div>
            <div class="fact__content">
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="fact">
            <div class="fact__icon">
              <img src="{{asset('image/icon-logo/about-us-icon4.png')}}" alt="about icon">
            </div>
            <div class="fact__content">
  ...
  <div class="skill-area bg--white">
    <div class="container-fluid p-0">
      <div class="row g-0 align-items-center">
        ...
        <div class="col-xl-6">
          <div class="img-box text-center">
            <img src="{{asset('image/others/about-us-sec-2.jpg')}}" alt="about image">
          </div>
        </div>
      </div>
    </div>
